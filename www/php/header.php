...
<html>
	<head>
		<title>Petshop - DMGG - Teu cão na minha mão</title>
		<!--meta-->
		<meta charset="UTF-8" />
	...
	<body class="<?php echo (isset($_COOKIE['cs_layout']) && $_COOKIE['cs_layout']=="boxed" ? (isset($_COOKIE['cs_layout_style']) && $_COOKIE['cs_layout_style']!="" ? $_COOKIE['cs_layout_style'] . ' ' . $_COOKIE['cs_image_overlay'] : 'image-1 overlay') : ''); ?>">
		<div class="site-container<?php echo (isset($_COOKIE['cs_layout']) && $_COOKIE['cs_layout']=="boxed" ? ' boxed' : ''); ?>">
		<!--<div class="site-container boxed">-->
			...
			<div class="header-container sticky<?php echo (isset($_COOKIE['cs_menu_type']) ? ' ' . $_COOKIE['cs_menu_type'] : '');?>">
