				...
				<div class="page-header-right">
					<div class="bread-crumb-container">
						...
						<ul class="bread-crumb">
							...
							<li>
								<a title="Recent Galleries" href="?page=galleries">
									RECENT GALLERIES
								</a>
							</li>
							<li class="separator">
	...
	<div class="clearfix">
		<div class="row margin-top-70">
			<div class="column column-1-2">
				<a href="images/samples/870x580/image_03.jpg" class="prettyPhoto re-preload" title="Lube Services">
					<img src='images/samples/570x380/image_03.jpg' alt='img'>
				</a>
				<div class="row margin-top-30">
					<div class="column column-1-2">
						<a href="images/samples/870x580/image_04.jpg" class="prettyPhoto re-preload" title="Lube Services">
							<img src='images/samples/570x380/image_04.jpg' alt='img'>
						</a>
					</div>
					<div class="column column-1-2">
						<a href="images/samples/870x580/image_08.jpg" class="prettyPhoto re-preload" title="Lube Services">
							<img src='images/samples/570x380/image_08.jpg' alt='img'>
						</a>
					</div>
				</div>
				<div class="row margin-top-30">
					<a href="images/samples/870x580/image_02.jpg" class="prettyPhoto re-preload" title="Lube Services">
